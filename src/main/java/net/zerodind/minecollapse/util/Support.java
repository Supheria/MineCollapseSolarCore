...
import net.zerodind.minecollapse.recipes.BlockIngredient;

public final class Support
{
    public static final DataManager<Support> MANAGER = new DataManager<>(new ResourceLocation(MineCollapse.MODID, "supports"), "support", Support::new, Support::new, Support::encode, Packet::new);
