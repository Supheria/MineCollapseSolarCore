...
{
    private static final String VERSION = ModList.get().getModFileById(MineCollapse.MODID).versionString();
    private static final SimpleChannel CHANNEL = NetworkRegistry.newSimpleChannel(new ResourceLocation(MineCollapse.MODID, "network"), () -> VERSION, VERSION::equals, VERSION::equals);
